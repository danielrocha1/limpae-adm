...
export default function AdminLayout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-[#f4f7fb] text-foreground dark:bg-[#07111f]">
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-50 flex w-72 flex-col border-r border-white/10 bg-[#0b1726] text-slate-100 shadow-2xl transition-transform duration-300 lg:translate-x-0",
